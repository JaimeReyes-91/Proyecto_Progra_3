...
public class TicketServicio {
    ...
    private final TimeLineServicio timelineServicio =
            new TimeLineServicio();
    ...
    public Ticket crear(
        ...
        int idGenerado =
                ticketDAO.obtenerSiguienteId();

        String codigo =
                CodigoTicketUtil.generarCodigo(idGenerado);
