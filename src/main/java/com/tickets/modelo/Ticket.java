...
public class Ticket {
	...
	public Ticket(int id, String codigo, String descripcion, EstadoTicket estadoActual, String fechaCreacion,
			String fechaCierre, int creadoPor, Integer asignadoA) {
		this.id = id;
		this.codigo = codigo;
